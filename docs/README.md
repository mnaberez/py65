...
[VICE emulator's monitor](http://vice-emu.sourceforge.net/vice_12.html)
...
**Note:** Unlike the VICE monitor, Py65Mon's `load` command does not expect
...
**Note:** Unlike the VICE monitor, Py65Mon's `save` command does not write
...
**Note:** After the instruction executes, the disassembly of the **next**
instruction is printed.  This allows you to see what will be executed on
the next step.
